...
// GraphMaker
function GraphMaker() {
  this.ptr = _emscripten_bind_GraphMaker_GraphMaker_0();
  getCache(GraphMaker)[this.ptr] = this;
};;
GraphMaker.prototype = Object.create(WrapperObject.prototype);
GraphMaker.prototype.constructor = GraphMaker;
GraphMaker.prototype.__class__ = GraphMaker;
GraphMaker.__cache__ = {};
Module['GraphMaker'] = GraphMaker;

GraphMaker.prototype['makeGraph'] = GraphMaker.prototype.makeGraph = function() {
  var self = this.ptr;
  _emscripten_bind_GraphMaker_makeGraph_0(self);
};;

  GraphMaker.prototype['__destroy__'] = GraphMaker.prototype.__destroy__ = function() {
  var self = this.ptr;
  _emscripten_bind_GraphMaker___destroy___0(self);
};
(function() {
  function setupEnums() {
